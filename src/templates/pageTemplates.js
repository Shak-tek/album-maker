...
export const pageTemplates = [
    {
        ...
        thumbnailUrl: '/ICON_TEMPLATE_7_LANDSCAPE.png',
    },
    {
        id: 1,
        name: '2‑Up (Side‑by‑Side)',
        slots: [3, 4],         // CSS: .slot4, .slot5
        thumbnailUrl: '/ICON_TEMPLATE_4_LANDSCAPE.png',
    },
    {
        id: 2,
        name: '4‑Up (Grid 2×2)',
        slots: [5, 6, 7, 8],   // CSS: .slot6, .slot7, .slot8, .slot9
        thumbnailUrl: '/ICON_TEMPLATE_5_LANDSCAPE.png',
    },
    {
        id: 3,
        name: '1‑Up (Full‑Bleed)',
        slots: [9],            // CSS: .slot10
        thumbnailUrl: '/ICON_TEMPLATE_3_LANDSCAPE.png',
    },
